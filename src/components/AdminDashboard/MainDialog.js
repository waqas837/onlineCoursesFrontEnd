...
import { MainCyan, useStyles } from "./Main.Styles";
// just remember that: if postCheck is true it will add a post ,else edit a post
const AddAndEditMemberDialog = ({ open, setopen, user, post, comment ,member }) => {
  console.log(member)
                 ...
                 return (
                  ...
                  <Grid container>
                            <Grid item xs={6} sm={6} md={6} lg={6} xl={6}>
                              <img style={{borderRadius:"10px"}} src={dummyimg} alt=""  width="70%" height="70px" />
                            </Grid>
                            <Grid item xs={6} sm={6} md={6} lg={6} xl={6}>
                              <img style={{borderRadius:"10px"}}  src={dummyimg} alt=""  width="70%" height="70px" />
                            </Grid>
